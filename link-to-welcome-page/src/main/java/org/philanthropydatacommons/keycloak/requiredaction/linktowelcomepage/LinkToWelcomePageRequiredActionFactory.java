...
public final class LinkToWelcomePageRequiredActionFactory implements RequiredActionFactory {
  ...
  // bundle. Kebab-case to match Keycloak's own keys.
  ...
  public List<ProviderConfigProperty> getConfigMetadata() {
    // Only TARGET_CLIENT_PROP. The super config adds the AIA-only "Maximum Age
    // of Authentication" field, which has no effect for NOT_SUPPORTED providers.
  ...
  public void validateConfig(
    ...
    // Not RequiredActionFactory.super.validateConfig: that parses the AIA-only
    // MAX_AUTH_AGE_KEY, which does not apply to this NOT_SUPPORTED provider.
    String targetClient =
