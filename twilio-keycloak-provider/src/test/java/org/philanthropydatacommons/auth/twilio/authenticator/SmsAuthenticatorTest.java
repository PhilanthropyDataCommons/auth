...
/** Tests for {@link SmsAuthenticator}. */
...
public class SmsAuthenticatorTest {
  ...
  void setup() throws IOException {
    ...
    when(mockAuthenticationFlowContext.getAuthenticatorConfig())
        .thenReturn(mockAuthenticatorConfigModel);
  ...
  @Test
  // A mock would run SmsSender's static initializer, which fails without Twilio env vars.
  // GLM-5.3-Flash
  @SuppressWarnings("NullAway")
  void getLocalizedSmsTextCorrectlyFormatsMessage() throws IOException {
    ...
    String smsText =
        smsAuthenticator.getLocalizedSmsText(this.mockAuthenticationFlowContext, code, ttl);
