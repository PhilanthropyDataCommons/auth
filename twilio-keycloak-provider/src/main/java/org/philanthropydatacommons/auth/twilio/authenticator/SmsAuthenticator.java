...
/** An authenticator that validates a one-time passcode sent to the user's mobile number via SMS. */
public class SmsAuthenticator implements Authenticator {
  ...
  /** Creates an authenticator that sends SMS via a default {@link SmsSender}. */
  ...
  String getLocalizedSmsText(AuthenticationFlowContext context, String code, Duration ttl) {
    ...
    try {
      ...
      throw new KeycloakThemeConfigurationException(
          "Expected to find the `"
              + SMS_FORMAT_PROPERTY_NAME
              + "` property in the LOGIN theme but lookup failed.",
          ioe);
    }
  }
